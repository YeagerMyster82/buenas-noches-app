...
export async function configureRevenueCat(userEmail) {
  ...
  // configure() is CAPPluginReturnNone — native initializes synchronously and never resolves the promise.
  // Do not await it; just fire and give the bridge a moment to process before subsequent calls.
  Purchases.configure({ apiKey, appUserID: userEmail || undefined });
