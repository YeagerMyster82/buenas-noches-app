const profileContent = {
  es: {
    EL_INAGOTABLE: {
      name: "El Incansable",
      description:
        "Tu hijo llega a la hora de dormir completamente encendido. Más tonto, más activo, más difícil de calmar justo cuando más necesita descansar. No es que no quiera dormir, es que su sistema nervioso llegó a la noche en alerta máxima y necesita una guía específica para poder soltarse. Con las herramientas correctas, ese interruptor se puede apagar con mucha más calma de lo que imaginas.",
    },
    EL_DESVELADO: {
      name: "El Vigilante Nocturno",
      description:
        "Tu hijo se queda quieto en la cama pero sus ojos no se cierran. El cuerpo está ahí, pero la mente no para. No hay drama, no hay llanto, solo un niño que parece incapaz de soltar el día aunque esté agotado. Su sistema nervioso está en modo alerta silenciosa, y lo que necesita no es más oscuridad ni más silencio, sino una señal precisa de que ya es seguro descansar.",
    },
    EL_NEGOCIADOR: {
      name: "El Negociador",
      description:
        "Un cuento más. Un vaso de agua. Una pregunta más. Tu hijo tiene mil razones para no quedarse solo en la oscuridad y las usa todas. No es manipulación, es conexión. Su sistema nervioso necesita sentirse seguro contigo antes de poder soltarse, y una vez que entiendes eso, la negociación deja de ser una batalla y se convierte en el camino al descanso.",
    },
    EL_BERRINCHE: {
      name: "El Volcán Emocional",
      description:
        "La hora de dormir se convierte en una tormenta emocional. Cualquier cosa pequeña lo desborda, un calcetín mal puesto, la luz equivocada, una palabra de más. Tu hijo no está siendo dramático, está agotado y su sistema nervioso ya no tiene recursos para regular las emociones. Lo que parece un berrinche es en realidad una señal de que necesita ayuda para aterrizar, y hay una manera de dársela sin que la noche se convierta en un campo de batalla.",
    },
    EL_SONAMBULO: {
      name: "El Explorador Nocturno",
      description:
        "Tu hijo se duerme sin problema pero aparece en tu cuarto a las 2am, o simplemente se despierta y no puede volver a dormirse solo. El problema no es quedarse dormido, es mantenerse dormido. Su sistema nervioso se activa en algún punto del ciclo del sueño y no sabe cómo regresar al descanso por su cuenta. La buena noticia es que eso tiene solución, y no implica noches interminables para siempre.",
    },
  },
  en: {
    EL_INAGOTABLE: {
      name: "The Tireless One",
      description:
