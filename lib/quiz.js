const profileContent = {
  es: {
    EL_INAGOTABLE: {
      name: "El Incansable",
      description:
        "Este perfil aparece cuando tu hijo ya pasó su ventana de sueño y el cuerpo entra en segunda energía. Parece que tiene batería infinita, pero en realidad está funcionando con cansancio acumulado.",
    },
    EL_DESVELADO: {
      name: "El Vigilante Nocturno",
      description:
        "Tu hijo está cansado, pero su sistema nervioso se queda en modo alerta. Quiere dormir, pero su cuerpo sigue vigilando y no encuentra la señal clara para soltar el día.",
    },
    EL_NEGOCIADOR: {
      name: "El Negociador",
      description:
    ...
    EL_BERRINCHE: {
      ...
      description:
        "La hora de dormir llega con mucha activación emocional. El sistema nervioso está sobrepasado, como un volcán listo para explotar, y necesita contención antes de poder recibir instrucciones o calma.",
    },
    EL_SONAMBULO: {
      name: "El Explorador Nocturno",
      description:
        "Tu hijo puede quedarse dormido, pero no siempre sostiene bien el sueño. Su cuerpo sigue explorando la noche porque muchas veces cayó por agotamiento antes de completar una bajada real del sistema nervioso.",
    },
  },
  en: {
    EL_INAGOTABLE: {
