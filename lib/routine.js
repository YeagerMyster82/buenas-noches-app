...
Object.assign(phaseLabels, {
  ...
  bano_tibio: "Bañarse con agua tibia",
  ponerse_pijama: "Ponerse pijamas",
  conectar: "Conectar",
  cepillarse_los_dientes: "Cepillarse los dientes",
  ir_al_bano: "Ir al baño",
  gargaras_tarareo_mmm: "Gárgaras / tarareo / mmm",
  a_la_cama: "A la cama",
...
Object.assign(phasePurpose, {
  ...
  bano_tibio: "Agua tibia y ambiente tranquilo para bajar el ritmo.",
  ponerse_pijama: "Una señal clara de que el día empieza a cerrarse.",
  ...
  ir_al_bano: "Última ida al baño antes de pasar a la cama.",
  gargaras_tarareo_mmm: "Tres minutos para combinar gárgaras, tarareo, sonido mmm o ponerse de cabeza según lo que tu hijo tolere.",
...
Object.assign(specialGuidance, {
  bano_tibio: {
    title: "Bañarse con agua tibia",
    guidance: "Baño o ducha tibia, sin juego activo ni estimulación extra.",
    examples: ["Agua tibia", "Voz baja", "Sin juego intenso"],
  },
  ponerse_pijama: {
    title: "Ponerse pijamas",
    guidance: "Ponerse la pijama con luz suave y ambiente calmado.",
    examples: ["Luz baja", "Movimiento tranquilo", "Voz calmada"],
  },
  cepillarse_los_dientes: {
    title: "Cepillarse los dientes",
    guidance: "Cepillar los dientes con calma, sin juego ni apuro.",
    examples: ["Ritmo lento", "Sin pantallas", "Sin carreras"],
  },
  ir_al_bano: {
    title: "Ir al baño",
    guidance: "Ir al baño una última vez antes de pasar a la cama.",
    examples: ["Última vez", "Sin volver al baño después", "Transición tranquila"],
  },
  gargaras_tarareo_mmm: {
    title: "Gárgaras, tarareo, sonido mmm o ponerse de cabeza",
    guidance: "Durante 3 minutos pueden hacer una combinación de gárgaras, tarareo, sonido mmm o ponerse de cabeza, o solo lo que tu hijo pueda tolerar con calma.",
    examples: ["Gárgaras si las tolera", "Tarareo suave", "Sonido mmm con labios cerrados", "Ponerse de cabeza si le gusta y es seguro"],
  },
  a_la_cama: {
    title: "A la cama",
...
Object.assign(activityCatalog, {
  ...
  ponerse_de_cabeza: {
    id: "ponerse_de_cabeza",
    displayName: "Ponerse de cabeza",
    shortLabel: "Vestibular vagal",
    instructions: "Un momento corto boca abajo o invertido si le gusta, siempre con seguridad y sostén.",
  },
  hablar_del_dia: {
    id: "hablar_del_dia",
  ...
  presion_cuento: {
    ...
    instructions: "Aplica presión profunda lenta y/o compresiones articulares mientras lees un cuento corto.",
  ...
  presion_cancion: {
    ...
    instructions: "Presión profunda lenta y/o compresiones articulares con canción repetitiva o tarareo.",
    comboGroup: "presion_voz",
  },
  ...
  ojos_soplar_respirar: {
    ...
    instructions: "Movimientos oculares lentos, soplar velitas, oler la flor o respiración de conejo con respiración tranquila.",
  ...
  presion_susurro: {
    ...
    instructions: "Presión profunda y/o compresiones articulares con frases calmadas y voz bajita.",
    comboGroup: "presion_voz",
  },
  presion_contar: {
    id: "presion_contar",
    ...
    instructions: "Presión profunda y/o compresiones articulares mientras cuentas lento con voz baja.",
    comboGroup: "presion_voz",
  },
  sandwich_almohadas: {
    ...
    instructions: "Presión suave con almohadas y, si ayuda, compresiones articulares, cuento o canción tranquila.",
  ...
  rodillo_almohada: {
    ...
    instructions: "Presión lenta con almohada, y si ayuda compresiones articulares, acompañada de respiración o voz suave.",
    comboGroup: "presion_contencion",
  },
  peluche_pesado: {
    id: "peluche_pesado",
    ...
    instructions: "Peluche con presión suave y/o compresiones articulares con cuento o canción tranquila.",
    comboGroup: "presion_contencion",
  },
  mecer_tararear: {
    id: "mecer_tararear",
    ...
    shortLabel: "Contacto + ritmo",
    instructions: "Mecerse suave mientras tarareas de forma repetitiva. Puedes sumar presión profunda o compresiones articulares si eso le ayuda.",
    comboGroup: "contacto_respiracion",
  },
  audio_calmado: {
    id: "audio_calmado",
...
Object.assign(profileOrders, {
  EL_INAGOTABLE: ["mover", "bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras_tarareo_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "dormir"],
  EL_DESVELADO: ["mover", "bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras_tarareo_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "dormir"],
  EL_NEGOCIADOR: ["conectar", "bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras_tarareo_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "limite_claro", "dormir"],
  EL_BERRINCHE: ["bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras_tarareo_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "dormir"],
  EL_SONAMBULO: ["bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras_tarareo_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "dormir"],
});
...
export function buildPlan({
  ...
  const safePrepareDuration = Math.max(5, Math.min(90, Number(prepareDuration) || 25));
  const customPhaseDurations = {
    ...phaseDurations,
    preparar_para_dormir: safePrepareDuration,
    bano_tibio: Math.max(3, Math.round(safePrepareDuration * 0.6)),
    ponerse_pijama: Math.max(2, Math.round(safePrepareDuration * 0.25)),
    cepillarse_los_dientes: 3,
    ir_al_bano: 2,
  };
  ...
  // Phases that belong BEFORE dinner (exercise, bath, pijama)
  const beforeDinnerPhases = ["mover", "conectar", "bano_tibio", "ponerse_pijama", "banarse_y_pijamas", "preparar_para_dormir"];
  const DINNER_BUFFER = 30;
  const dinnerMin = toMinutes(resolvedDinnerTime);
  const routineStartMin = toMinutes(routineStart);
  const bedtimeMin = toMinutes(bedtime);
  const dinnerConflict = dinnerMin > routineStartMin && dinnerMin < bedtimeMin;

  // When dinner conflicts, reschedule pre-dinner steps to END at dinner time,
  // and post-dinner steps to START after dinner + buffer.
  const preDinnerDuration = order
    .filter((pk) => beforeDinnerPhases.includes(pk))
    .reduce((sum, pk) => sum + (customPhaseDurations[pk] || 3), 0);
  const adjustedPreDinnerStart = dinnerConflict ? dinnerMin - preDinnerDuration : routineStartMin;
  const adjustedPostDinnerStart = dinnerConflict ? dinnerMin + DINNER_BUFFER : null;

  let cursor = adjustedPreDinnerStart;
  const bedtimeMinutes = bedtimeMin;

  const steps = order.map((phaseKey, index) => {
    const stepId = `${phaseKey}-${index + 1}`;
    const duration = customPhaseDurations[phaseKey] || 3;

    // Jump cursor to post-dinner start at the boundary between pre/post-dinner phases
    const isBeforeDinner = beforeDinnerPhases.includes(phaseKey);
    const prevPhaseKey = index > 0 ? order[index - 1] : null;
    const prevWasBeforeDinner = prevPhaseKey ? beforeDinnerPhases.includes(prevPhaseKey) : true;
    if (dinnerConflict && !isBeforeDinner && prevWasBeforeDinner) {
      cursor = adjustedPostDinnerStart;
    }
  ...
  // When dinner splits the routine, the actual bedtime shifts later
  const lastStep = steps[steps.length - 1];
  const adjustedBedtime = dinnerConflict && lastStep ? lastStep.end : bedtime;
  ...
  return {
    ...
    routineStart: dinnerConflict ? fromMinutes(adjustedPreDinnerStart) : routineStart,
    dinnerConflict,
    steps,
  };
}
...
function calculateBedtime({ ageYears, wakeTime, napTaken, napWakeTime }) {
  ...
  if (ageYears >= 2 && ageYears <= 5 && napTaken && napWakeTime) {
    // After-nap: 6.5 h of awake time → matches calculateSleepWindow's 390 min post-nap logic
    bedtimeMinutes = toMinutes(napWakeTime) + 390;
  } else if (ageYears >= 3 && !napTaken) {
    // Ages 3-4 no nap: calculateSleepWindow window max is 780; use midpoint 765 (~12h45m)
    bedtimeMinutes = toMinutes(wakeTime) + (ageYears < 5 ? 750 : 765);
  } else if (napTaken && napWakeTime) {
    bedtimeMinutes = toMinutes(napWakeTime) + 390;
  } else if (ageYears >= 2 && ageYears < 3 && !napTaken) {
    // Age 2, no nap: calculateSleepWindow range is [660,720]; use max (720) as target
    bedtimeMinutes = toMinutes(wakeTime) + 720;
  } else {
    // Age < 2 without nap data: use 720 min (12 h) as a safe conservative default
    bedtimeMinutes = toMinutes(wakeTime) + 720;
  }
