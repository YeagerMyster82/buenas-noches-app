...
Object.assign(phasePurpose, {
  ...
  gargaras: "Una señal oral y vagal breve para empezar a activar calma.",
  tarareo: "Vibración suave para decirle al cuerpo que puede bajar.",
  sonido_mmm: "Sonido suave con labios cerrados para regular sin activar.",
...
Object.assign(specialGuidance, {
  ...
  gargaras: {
    title: "Gárgaras",
    guidance: "Hacer gárgaras breves con supervisión si lo tolera bien.",
    examples: ["2 minutos", "Suave", "Sin hacerlo juego activo"],
  },
  tarareo: {
    title: "Tarareo",
    guidance: "Tararear una canción o sonido continuo y suave.",
    examples: ["2 minutos", "Voz baja", "Ritmo repetitivo"],
  },
  sonido_mmm: {
    title: "Sonido mmm",
    guidance: "Hacer sonido mmm con labios cerrados, lento y suave.",
    examples: ["2 minutos", "Suave", "Sin forzar"],
  },
  a_la_cama: {
    title: "A la cama",
...
Object.assign(profileOrders, {
  EL_INAGOTABLE: ["mover", "bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras", "tarareo", "sonido_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "dormir"],
  EL_DESVELADO: ["mover", "bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras", "tarareo", "sonido_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "dormir"],
  EL_NEGOCIADOR: ["conectar", "bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras", "tarareo", "sonido_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "limite_claro", "dormir"],
  EL_BERRINCHE: ["bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras", "tarareo", "sonido_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "dormir"],
  EL_SONAMBULO: ["bano_tibio", "ponerse_pijama", "cepillarse_los_dientes", "ir_al_bano", "gargaras", "tarareo", "sonido_mmm", "a_la_cama", "calmar_el_cuerpo", "extra_calma", "dormir"],
});
