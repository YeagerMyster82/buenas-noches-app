export const phaseLabels = {
  ...
  bano_regulacion: "Activar calma en el bano",
  vago: "Activar calma",
...
const phasePurpose = {
  ...
  bano_regulacion:
    "Como ya estan en el bano, aqui aprovechamos para sumar senales de calma mientras hacen cosas que igual tienen que hacer.",
...
const activityCatalog = {
  bath_or_shower: {
    id: "bath_or_shower",
    displayName: "Bano o ducha tibia",
    shortLabel: "Bajar el ritmo del dia",
    instructions: "Dar un bano o ducha tibia, sin juego activo ni estimulacion extra.",
  },
  put_on_pajamas: {
    id: "put_on_pajamas",
    displayName: "Ponerse pijama",
    shortLabel: "Senal clara de noche",
    instructions: "Ponerse la pijama con luz suave y ambiente calmado.",
  },
  dim_lights: {
    id: "dim_lights",
    displayName: "Bajar la luz",
    shortLabel: "Reducir estimulacion",
    instructions: "Bajar la intensidad de la luz o cambiar a luz calida.",
  },
  remove_screens: {
    id: "remove_screens",
    displayName: "Apagar pantallas",
    shortLabel: "Menos input visual",
    instructions: "Apagar pantallas y evitar estimulos visuales intensos.",
  },
  calm_voice_transition: {
    id: "calm_voice_transition",
    displayName: "Voz calmada",
    shortLabel: "Co-regulacion suave",
    instructions: "Hablar bajito y evitar excitacion verbal mientras empieza la rutina.",
  },
  use_bathroom: {
    id: "use_bathroom",
    displayName: "Ir al bano",
    shortLabel: "Evitar salidas despues",
    instructions: "Ir al bano antes de pasar a la cama para evitar interrupciones despues.",
  },
  brush_teeth: {
    id: "brush_teeth",
...
const profileOrders = {
  A: ["preparar_para_dormir", "movimiento_descarga", "propiocepcion", "vestibular_lento", "bano_regulacion", "respiracion", "transicion"],
  B: ["preparar_para_dormir", "activacion_ligera", "propiocepcion", "ritmo", "bano_regulacion", "respiracion", "audio_historia_corta", "transicion"],
  C: ["preparar_para_dormir", "conexion", "propiocepcion", "ritmo", "bano_regulacion", "respiracion", "limite_claro", "transicion"],
  D: ["preparar_para_dormir", "propiocepcion_profunda", "contacto_ritmo", "bano_regulacion", "respiracion", "transicion"],
  E: ["preparar_para_dormir", "trabajo_pesado_movimiento", "propiocepcion_fuerte", "vestibular_lento", "bano_regulacion", "respiracion", "transicion"],
  F: ["preparar_para_dormir", "conexion", "propiocepcion_profunda", "contacto_ritmo", "bano_regulacion", "respiracion", "retirada_gradual", "transicion"],
  G: ["preparar_para_dormir", "movimiento_corporal", "propiocepcion", "ritmo", "bano_regulacion", "respiracion", "audio_historia_corta", "transicion"],
  H: ["preparar_para_dormir", "propiocepcion", "ritmo", "bano_regulacion", "respiracion", "transicion"],
};
...
const dropdownOptions = {
  A: {
    ...
    bano_regulacion: ["use_bathroom", "brush_teeth", "gargling", "humming", "eye_movement_vagal_sequence"],
  ...
  B: {
    ...
    bano_regulacion: ["use_bathroom", "brush_teeth", "closed_mouth_humming", "humming", "eye_movement_vagal_sequence"],
  ...
  C: {
    ...
    bano_regulacion: ["use_bathroom", "brush_teeth", "gargling", "humming", "closed_mouth_humming"],
    respiracion: ["belly_breathing", "smell_flower_blow_candle", "bunny_breaths", "guided_short_breathing", "exhale_longer_than_inhale"],
  ...
  F: {
    ...
    bano_regulacion: ["use_bathroom", "brush_teeth", "humming_together", "closed_mouth_humming", "eye_movement_vagal_sequence"],
  ...
  G: {
    ...
    bano_regulacion: ["use_bathroom", "brush_teeth", "eye_movement_vagal_sequence", "humming", "gargling"],
...
export function buildPlan({
  ...
  const totalDuration = order.reduce((sum, phaseKey) => sum + (phaseDurations[phaseKey] || 3), 0);
  const bedtime = targetBedtime || calculateBedtime({ ageYears, wakeTime, napTaken, napWakeTime });
