...
export async function getAdminDashboardData() {
  ...
  if (childrenError || quizResultsError || logsError || messagesError || reviewsError) {
    throw new Error(
      childrenError?.message || quizResultsError?.message || logsError?.message || messagesError?.message || reviewsError?.message
    );
  }
