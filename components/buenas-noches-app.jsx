      ...
      <section className="grid">
        ...
        <aside className="sidebar">
          <article className="card">
            ...
            {state.wantsRoutine && !state.purchaseEmail && (
              <div className="stack">
                <p>
                ...
                <p className="muted">
                  En producción, este correo se validará con Supabase y con el webhook de Captivation Hub.
                </p>
              </div>
            )}
            {state.purchaseEmail && (
          ...
          {state.result && state.purchaseEmail && (
            <article className="card">
              <div className="card-header">
